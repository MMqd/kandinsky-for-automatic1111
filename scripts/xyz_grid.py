...
from kandinsky import KProcessed
...
axis_options = [
    ...
    AxisOption("Prior CFG Scale", float, apply_field("cfg_scale")),
    AxisOption("Prior Inference Steps", float, apply_field("cfg_scale")),
...
def draw_xyz_grid(p, xs, ys, zs, x_labels, y_labels, z_labels, cell, draw_legend, include_lone_images, include_sub_grids, first_axes_processed, second_axes_processed, margin_size):
    ...
    def process_cell(x, y, z, ix, iy, iz):
        ...
        processed: KProcessed = cell(x, y, z, ix, iy, iz)
